  ...
  <div>
    ...
    <div class="nc-text-input-container">
      ...
      >
        <template v-slot:iconLeft>
          <div
            class="nc-phone-input-example country-code">
            <img 
              class="nc-phone-input-example flag"
            ...
            />
            <span 
              class="nc-phone-input-example code-number"
            >+34</span>
          </div>
        </template>
      </nc-text-input>
...
.nc-phone-input-example {
  display: flex;
}
.nc-phone-input-example.country-code {
  display: flex;
  align-items: center;
  padding-left: 7px;
  padding-right: 15px;
...
.nc-phone-input-example .code-number {
  width: 18px;
  height: 22px;
  font-size: 17px;
}

.nc-phone-input-example .flag {
  color: #272727;
  font-size: 15px;
  width: 19px;
  height: 14px;
